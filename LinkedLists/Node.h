...
/*
  ...
  This file contains all the function prototypes for the Node.cpp file. It creates the nodes, sets the value of the nodes, and then gets and sets the next nodes.  
  Author: Diya Shah
  Date: 11/15/2024
